...
jMoment.loadPersian = function (args) {
  ...
  , { months: ('ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژوئیه_اوت_سپتامبر_اکتبر_نوامبر_دسامبر').split('_')
    ...
    , jMonths:
      {
        'persian': ('حمل_ثور_جوزا_سَرَطان_ااسد_سنبله_ميزان_عَقرب_قوس_جَدي_دَلو_حوت').split('_'),
        'persian-modern': ('حمل_ثور_جوزا_سَرَطان_اسد_سنبله_ميزان_عَقرب_قوس_جَدي_دَلو_حوت').split('_')
      }[dialect]
    , jMonthsShort:
      {
