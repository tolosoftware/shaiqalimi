...
/* harmony import */ var _proposals_Organizationadd_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./proposals/Organizationadd.vue */ "./resources/js/src/views/apps/projects/proposals/Organizationadd.vue");
/* harmony import */ var _DataViewSidebar_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DataViewSidebar.vue */ "./resources/js/src/views/apps/projects/DataViewSidebar.vue");
/* harmony import */ var _data_list_moduleDataList_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./data-list/moduleDataList.js */ "./resources/js/src/views/apps/projects/data-list/moduleDataList.js");
/* harmony import */ var _ProjectList_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ProjectList.vue */ "./resources/js/src/views/apps/projects/ProjectList.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Organizationadd: _proposals_Organizationadd_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    ProjectList: _ProjectList_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      selectedOrg: null,
      // Project Form
      pForm: new vform__WEBPACK_IMPORTED_MODULE_9__["Form"]({
        s_number: '',
        issue_date: '',
        issue_address: '',
        source_address: '',
  ...
  methods: (_methods = {
    ...
    setPFromValue: function setPFromValue(resp) {
      var _arr = _babel_runtime_core_js_object_entries__WEBPACK_IMPORTED_MODULE_2___default()(resp);
    ...
    viewProject: function viewProject(id) {
      // Vue.$forceUpdate();
      this.$route.params("/projects/project/" + id).catch(function () {});
    }
