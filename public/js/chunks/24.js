...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    AlertError: vform__WEBPACK_IMPORTED_MODULE_7__["AlertError"]
  },
  data: function data() {
    var _ref;
    ...
    return _ref = {
      ...
      mainSNumber: 0,
      // Project Form
      pForm: new vform__WEBPACK_IMPORTED_MODULE_7__["Form"]({
        s_number: '',
        issue_date: '',
        issue_address: '',
        source_address: '',
  ...
  methods: (_methods = {
    ...
    getLastProj: function getLastProj() {
      ...
      this.axios.get('/api/project-last').then(function (response) {
        _this3.mainSNumber = response.data;
        _this3.pForm.s_number = _this3.mainSNumber;
      });
    },
              ...
              [
                _c("vx-card", { staticClass: "height-vh-80" }, [
                  _c("div", { staticClass: "vx-row" }, [
                    _c("div", { staticClass: "vx-col mb-base w-1/2" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("div", { staticClass: "vx-row" }, [
                        _c(
                          "div",
                          { staticClass: "vx-col mb-base w-1/3" },
                          [
                            _c("vs-input", {
                              directives: [
                                {
                        ...
                        _c(
                          "div",
                          { staticClass: "vx-col mb-base w-1/3 mt-4" },
                          [
                            _c("label", { attrs: { for: "" } }, [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "announce_id" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          "div",
                          { staticClass: "vx-col mb-base w-1/3 pt-5 pb-0" },
                          [
                            _c(
                              "label",
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "issue_date" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "issue_address" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          "div",
                          { staticClass: "vx-col mb-base w-1/3 mt-5" },
                          [
                            _c(
                              "label",
                              {
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "type" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "auth_number" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          "div",
                          { staticClass: "vx-col mb-base w-1/3 pt-4" },
                          [
                            _c("label", { attrs: { for: "" } }, [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "duration" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "price" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "offer_date" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "close_date" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "offer_price" }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("has-error", {
                              attrs: { form: _vm.pForm, field: "project_price" }
                            })
                          ],
                          1
                        )
