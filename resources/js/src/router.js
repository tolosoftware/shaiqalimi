  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: '/projects/list',
          component: () => import('./views/apps/projects/Project.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              {
        ...
        {
          path: '/projects/add',
          component: () => import('./views/apps/projects/ProjectAdd.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
        ...
        },
        {
          path: '/accounts',
          name: 'accounts',
          component: () => import('./views/apps/accounts/Account.vue'),
          meta: {
            breadcrumb: [
              {
                title: 'Home',
...

        {
          path: '/expenses',
          name: 'expenses',
          component: () => import('./views/apps/expenses/Expense.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
        ...
        },
        {
          ...
          name: 'fuel-station',
          component: () => import('./views/apps/inventory/add/FuelStation.vue'),
          meta: {
            breadcrumb: [
              {
                title: 'Home',
        ...
        },
        {
          path: '/procurment',
          name: 'procurment',
          component: () => import('./views/apps/procurments/Procurment.vue'),
          meta: {
            rule: 'editor'
          }
        },
        {
          path: '/archive',
          name: 'archive',
          component: () => import('./views/apps/archives/Archive.vue'),
          meta: {
            breadcrumb: [
              {
                title: 'Home',
        ...
        },
        {
          ...
          component: () => import('./views/apps/user/sub/UserEdit.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'project-view',
          component: () => import('./views/apps/projects/ProjectEdit.vue'),
          props: true,
          meta: {
            breadcrumb: [
              {
