<template>
  <div>
    ...
    <div class="vx-col w-full mb-base">
      <vx-card title="بیشترین انتقالات" class="no-shadow">
        <!-- CHART -->
        <div slot="no-body">
          <vue-apex-charts
            type="radialBar"
        ...
        <vs-collapse>
          <vs-collapse-item>
            <div slot="header">2000 لیتر به احمدیار</div>
...
عواید تانکهای تیل که بشکل کمیشن فعالیت دارند طور ذیل تعیین میگردد.
          ...
          <vs-collapse-item>
            <div slot="header">42000 لیتر به ذخیره یاران</div>
...
کمیشن بوده واز آن )70 )%مفاد خالص در نظرگرفته شده، مالیه آن قرارذیل ذیل صورت میگیرد:
          ...
          <vs-collapse-item>
            <div slot="header">21000 لیتر به ذخیره مکرویان</div>
...
تانکهای تیل که مصروف فروش انواع تیل یا گازLPG میباشد به تفکیک مقدار وقیمت فروش یکسان تطبیق میگردد.
 تمامی ادارات مالیاتی مطابق به احکام قانون مکلف به تطبیق این طرزالعمل میباشد.
          ...
          <vs-collapse-item>
            <div slot="header">200320 لیتر به ذخیره ارغنداب</div>
