                        ...
                        <div class="vx-row">
                            ...
                            <div class="vx-col w-1/3 mt-4">
                                ...
                                <div class="btn-group">
                                    <div class="vx-row pl-4 pr-4">
                                        <vs-button class="vx-col w-1/2 customstyle feather" color="success">
                            ...
                            <div class="vx-col w-1/3 mt-4">
                                ...
                                <div class="btn-group">
                                    <div class="vx-row pl-4 pr-4">
                                        <vs-button class="vx-col w-1/2 customstyle" color="success">
                                            <input class="form-check-input" type="radio" name="statustransaction" id="statusradio" value="option1" checked style="height:15px; width: 15px;" />
                                        ...
                                        <vs-button class="vx-col w-1/2 customstyle" color="success">
                                            <input class="form-check-input" type="radio" name="statustransaction" id="statusradio1" value="option1" checked style="height:15px; width: 15px;" />
                            ...
                            <div class="vx-col w-1/3">
                                <vs-input size="medium" v-validate="'projecttitle'" label="عنوان معامله" name="projecttitle" class="mt-5 w-full" />
                            </div>
