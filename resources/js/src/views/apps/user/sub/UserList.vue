  ...
  <div id="data-list-thumb-view" class="w-full data-list-container">
    ...
    >
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="category">وظیفه</vs-th>
        <vs-th sort-key="popularity">فعالیت</vs-th>
        <vs-th sort-key="order_status">وضعیت</vs-th>
        <vs-th sort-key="price">معاش</vs-th>
        <vs-th>بررسی</vs-th>
      </template>
...
<script>
import moduleDataList from '../../projects/data-list/moduleDataList.js'
